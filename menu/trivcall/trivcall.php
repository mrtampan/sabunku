...
$loop = $_POST["loop"];
$x = 0;
$data = array("applicationInfo" => "ANDROID", "country" => "ID", "deviceModel" => "ASUS_X00AD", "locale" => "in_ID", "method" => "IVR", "networkCode" => "51001", "phoneNumber" => "$no", "udid" => "f0d2f0e4a35230410424e0c5f519361b019ef56924f690349dcbc7d32636ab31");
